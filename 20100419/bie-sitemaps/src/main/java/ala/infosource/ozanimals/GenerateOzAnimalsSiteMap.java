...
public class GenerateOzAnimalsSiteMap implements Runnable {
	...
	public static void main(String[] args) throws Exception{
		...
		String[] speciesIndexPages = {
				"http://www.ozanimals.com/australian-bird-index.html",
				"http://www.ozanimals.com/australian-mammal-index.html",
				"http://www.ozanimals.com/australian-reptile-index.html",
				"http://www.ozanimals.com/australian-fish-index.html",
				"http://www.ozanimals.com/australian-insect-index.html",
				"http://www.ozanimals.com/australian-spider-index.html",
				"http://www.ozanimals.com/australian-frog-index.html"
		};
		...
		for (String speciesIndexPage : speciesIndexPages) {
			...
			Pattern p = Pattern.compile(
					"(?:<a href = \")" +
					"(http://www\\.ozanimals\\.com/[" + ExtractUtils.SCIENTIFIC_NAME_PATTERN + "/]{1,}\\.html)" +
					"(?:\" title=\"[" + ExtractUtils.SCIENTIFIC_NAME_PATTERN + "]{0,}\">[\\s]{0,})" +
