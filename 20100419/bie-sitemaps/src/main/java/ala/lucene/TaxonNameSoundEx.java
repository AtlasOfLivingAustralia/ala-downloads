...
/**
 * Java class taken from GBIF Portal code base that use's
 * Tony Ree's scientific name normalisation which gives better matching 
 * that soundex.
 */
