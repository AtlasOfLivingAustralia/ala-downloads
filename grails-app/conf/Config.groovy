...
security.cas.uriFilterPattern = "/download/.*,/recordCount/.*" // pattern for pages that require authentication
...
log4j = {
    ...
    info 'grails.app'
    debug 'grails.app.controllers.au.org.ala','ala','au.org.ala.download','au.org.ala.web'
}
